...
%>
<%
	pageContext.setAttribute("signUpUrl", "pages/front/user/userServlet/signUp");
%>
			...
			<div id="lBody" style="float:left;width:31%;margin-left:15px;">
				...
				<div class="add-comment styled boxed boxed-cream" id="addcomments">
					...
					<div class="comment-form">
						<form action="${signUpUrl}" method="post"  onsubmit="return validateRegeForm();" id="commentForm" name="commentForm" class="ajax_form">
							<div class="form-inner">
								<div class="field_text">
									...
									<input type="text" name="user.uid" id="user.uid" value=""
										placeholder="请输入用户名" class="inputtext input_middle required" style="width:180px"
										onblur="return validateUid();" /> <span id="user.uidSpan" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
								</div>
								<div class="clear"></div>
								<div class="field_text">
									<label for="subject" class="label_title"><strong>密码</strong></label>
									<input type="password" name="user.password" id="user.password" value=""
										placeholder="请输入用户名" class="inputtext input_middle required"  style="width:180px"
										onblur="return validatePassword()" /> <span id="user.passwordSpan">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
								</div>
								<div class="field_text">
									<label for="subject" class="label_title"><strong>确认密码</strong></label>
									<input type="password" name="confpassword" id="confpassword" value=""  style="width:180px"
										placeholder="请输入确认密码" class="inputtext input_middle required"
										onblur="return validateConfPassword()" /> <span id="confpasswordSpan">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
								</div>
								<div class="clear"></div>
							</div>
